 ...
 */
final class Version20251016114952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE accessory (id INT AUTO_INCREMENT NOT NULL, weight_id INT DEFAULT NULL, category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, stock INT NOT NULL, price DOUBLE PRECISION DEFAULT NULL, image VARCHAR(255) NOT NULL, is_best TINYINT(1) NOT NULL, INDEX IDX_A1B1251C350035DC (weight_id), INDEX IDX_A1B1251C12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE address (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, company VARCHAR(255) DEFAULT NULL, address VARCHAR(255) NOT NULL, postal VARCHAR(20) NOT NULL, city VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, phone VARCHAR(20) NOT NULL, type VARCHAR(50) DEFAULT NULL, INDEX IDX_D4E6F81A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE trottinette (id INT AUTO_INCREMENT NOT NULL, weight_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, name_short VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, description_short LONGTEXT DEFAULT NULL, image VARCHAR(255) NOT NULL, is_best TINYINT(1) NOT NULL, is_header TINYINT(1) NOT NULL, header_image VARCHAR(255) DEFAULT NULL, header_btn_title VARCHAR(255) DEFAULT NULL, stock INT NOT NULL, price DOUBLE PRECISION NOT NULL, INDEX IDX_44559939350035DC (weight_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE accessory ADD CONSTRAINT FK_A1B1251C350035DC FOREIGN KEY (weight_id) REFERENCES weight (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE accessory DROP FOREIGN KEY FK_A1B1251C350035DC');
